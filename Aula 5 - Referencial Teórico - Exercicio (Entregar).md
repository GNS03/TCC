...
| Dados (fígado)       | Os dados foram obtidos online e são interessantes para o projeto pois possuem multiplas classes, podendo ser utilizado para testar a performance dos modelos desenvolvidos.                                                        |
